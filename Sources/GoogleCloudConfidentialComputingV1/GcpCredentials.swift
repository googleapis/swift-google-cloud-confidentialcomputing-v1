...
public struct GcpCredentials: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  ...
  ///
  /// ```
  /// let value = GcpCredentials().with { $0.serviceAccountIdTokens = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.confidentialcomputing.v1.GcpCredentials"
  }

...
/// Space supports
public enum TokenType: Codable, Equatable, Sendable {
  ...
  public var intValue: Int? {
    ...
    case .oidc: return 1
    case .pki: return 2
    case .limitedAws: return 3
    case .awsPrincipaltags: return 4
  ...
  public var stringValue: Swift.String? {
    ...
    case .pki: return "TOKEN_TYPE_PKI"
    case .limitedAws: return "TOKEN_TYPE_LIMITED_AWS"
    case .awsPrincipaltags: return "TOKEN_TYPE_AWS_PRINCIPALTAGS"
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownStringValue`](doc:TokenType/unknownStringValue(_:)).
  public init(stringValue: Swift.String) {
    switch stringValue {
    case "TOKEN_TYPE_UNSPECIFIED": self = .unspecified
    case "TOKEN_TYPE_OIDC": self = .oidc
    case "TOKEN_TYPE_PKI": self = .pki
    case "TOKEN_TYPE_LIMITED_AWS": self = .limitedAws
    case "TOKEN_TYPE_AWS_PRINCIPALTAGS": self = .awsPrincipaltags
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownIntValue`](doc:TokenType/unknownIntValue(_:)).
  public init(intValue: Int) {
    switch intValue {
    case 0: self = .unspecified
    case 1: self = .oidc
    case 2: self = .pki
    case 3: self = .limitedAws
    case 4: self = .awsPrincipaltags
